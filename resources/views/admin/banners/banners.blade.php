                                            ...
                                            <table id="banners" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/add-edit-banner/'.$banner['id']) }}"><i style="font-size:25px" class="mdi mdi-pencil"></i></a>
                                                            <a title="banner" class="confirmDelete" href="{{url('admin/delete-banner/'.$banner['id']) }}"><i style="font-size:25px" class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
