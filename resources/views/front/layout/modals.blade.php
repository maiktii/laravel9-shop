                    ...
                    <div class="row align-items-center u-s-m-x-0">
                        <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                            <div class="newsletter-image">
                                <a target="_blank" rel="nofollow" href="javascript:void(0)" class="banner-hover effect-dark-opacity">
                                    <img class="img-fluid" src="{{ asset('admin/images/logomini.png') }}" alt="Newsletter Image">
                                </a>
                            </div>
                        </div>
