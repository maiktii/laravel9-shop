...
class Category extends Model
{
    ...
    public static function categoryDetails($url){
        ...
        if($categoryDetails['parent_id']==0){
            ...
            $breadcrumbs = '<li class="has=separator"><a href="'.url($categoryDetails['url']).'">'.$parentCategory['category_name'].'</a></li>
        ...
        // dd($catIds);
        $resp = array('catIds'=>$catIds, 'categoryDetail'=>$categoryDetails, 'breadcrumbs'=>$breadcrumbs);
        return $resp;
    }

    public static function getCategoryName($category_id){
        $getCategoryName = Category::select('category_name')
