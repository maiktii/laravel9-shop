    ...
    <div class="slider-main owl-carousel">
        ...
        <div class="bg-image">
            <div class="slide-content">
                <h1><a @if(!empty($banner['link'])) href="{{ url($banner['link']) }}" @else href="javascript:void(0);" @endif><img title="{{ $banner['title'] }}" src="{{ asset('front/images/banner_images/'.$banner['image']) }}"></a></h1>
                <h2>{{ $banner['title'] }}</h2>
            </div>
        </div>
        @endforeach
                        ...
                        <div class="products-slider owl-carousel" data-item="4">
                            ...
                            <div class="item">
                                <div class="image-container">
                                    ...
                                    @else
                                    <img class="img-fluid" src="{{asset('front/images/product_images/no-image.png') }}" alt="Product">
                                    @endif
                                    </a>
                            ...
                            <div class="item">
                                <div class="image-container">
                                    ...
                                    <div class="item-action-behaviors">
                                        ...
                                        <a class="item-addCart" href="{{url('/cart')}}">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="item-content">
                                    <div class="what-product-is">
...
<div class="banner-layer">
    <div class="container">
        <div class="image-banner">
            ...
            <img class="img-fluid" src="{{ asset('front/images/banner_images/'.$fixBanners[1]['image']) }}" alt="{{ $fixBanners[0]['alt'] }}" title="{{ $fixBanners[0]['title'] }}">
            </a>
        </div>
    </div>
</div>
