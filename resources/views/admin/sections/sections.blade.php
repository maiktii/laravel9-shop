                                            ...
                                            <table id="sections" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/add-edit-section/'.$section['id']) }}"><i style="font-size:25px" class="mdi mdi-pencil"></i></a>
                                                            <a title="Section" class="confirmDelete" href="{{url('admin/delete-section/'.$section['id']) }}"><i style="font-size:25px" class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
