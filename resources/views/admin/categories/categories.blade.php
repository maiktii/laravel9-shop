                                            ...
                                            <table id="categories" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/add-edit-category/'.$category['id']) }}"><i style="font-size:25px" class="mdi mdi-pencil"></i></a>
                                                            <a title="Category" class="confirmDelete" href="{{url('admin/delete-category/'.$category['id']) }}"><i style="font-size:25px" class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
