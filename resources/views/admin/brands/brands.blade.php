                                            ...
                                            <table id="brands" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{url('admin/add-edit-brand/'.$brand['id']) }}"><i style="font-size:25px" class="mdi mdi-pencil"></i></a>
                                                            <a title="brand" class="confirmDelete" href="{{url('admin/delete-brand/'.$brand['id']) }}"><i style="font-size:25px" class="mdi mdi-delete"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
