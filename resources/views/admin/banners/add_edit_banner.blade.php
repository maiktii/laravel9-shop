              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control" id="image" placeholder="Enter banner image" name="image">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="alt" placeholder="Enter Banner alt" name="alt" @if(!empty($banner['alt'])) value="{{ $banner['alt'] }}" @else value="{{ old('alt') }}" @endif>
                    </div>
