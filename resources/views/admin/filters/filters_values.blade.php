                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a style="max-width: 150px; float: left; display:inline-block;" href="{{url('admin/add-edit-filter-value')}}" class="btn btn-block btn-primary">Add Filters Values</a>
                                        ...
                                        <div class="table-responsive pt-3">
                                            <table id="filters" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach($filters_value as $filter)
                                                    <tr>
                                                        <td>
                                                            {{ $filter['id'] }}
                                                        </td>
